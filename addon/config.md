...
- `friends_server`: the Fly race server. Defaults to the official one; set it to your own deployment (backend/ in the repo) or empty to keep the race local-only. `mock` shows example friends.
